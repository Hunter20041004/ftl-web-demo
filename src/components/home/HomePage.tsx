...
import { TransactionNetworkVisual } from "@/components/visual/TransactionNetworkVisual";
    ...
    <SitePageShell>
      <main id="main" className="page" data-visual-baseline="v1-main-fa033f0">
        <section className="hero">
          <TransactionNetworkVisual variant="hero" />
